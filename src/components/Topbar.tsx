        ...
        <div className="flex items-center gap-4">
          {isMobile ? (
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 gradient-header rounded-xl flex items-center justify-center text-white shadow-lg shadow-primary/20">
                <span className="font-black text-base">E</span>
              </div>
              <div className="flex flex-col">
                <span className="text-sm font-black tracking-tighter leading-none text-text-heading">EventLink</span>
                <span className="text-[9px] font-black uppercase tracking-widest text-primary mt-0.5">Admin</span>
              </div>
            </div>
          ) : (
            <div className="flex items-center gap-3 bg-bg-main border border-divider px-5 py-2.5 rounded-2xl w-80 transition-all focus-within:bg-white focus-within:border-primary/30 focus-within:shadow-lg focus-within:shadow-primary/5">
              <Search size={18} className="text-text-secondary" />
              <input 
                type="text" 
                placeholder="Search console..." 
                className="bg-transparent border-none outline-none text-sm w-full placeholder:text-text-secondary font-semibold"
              />
            </div>
          )}
        </div>
